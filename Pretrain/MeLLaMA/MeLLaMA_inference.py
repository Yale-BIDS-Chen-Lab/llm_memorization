...
llm = LLM(
    model="clinicalnlplab/me-llama", # raplace with llama2 model
    # tensor_parallel_size=2,
    dtype="bfloat16",
    gpu_memory_utilization=0.8,
    max_seq_len_to_capture=2048,
    download_dir = '/gpfs/radev/home/yf329/scratch/hf_models'
)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Run inference with llama2 model.')
        ...
        if len(batch_inputs) == batch_size or i == len(data) - 1:
            try:
                ...
                for j, generated_text in enumerate(generated_texts):
                    ...
                    data[data_idx]["llama3_response"] = generated_text
